...
const Roadmap = () => {
    return (
        <div
            id='roadmap'
            className=' w-[100vw] min-h-[100vh] pt-[100px] px-[10px] pb-5 text-black mb-6 bg-white'
        >
            ...
            <div id="how-to-buy" className=" w-full px-2 mb-6">
                <div className=" border-l border-l-slate-700 h-fit">
                    <div className=" flex items-center justify-start mb-4">
                        ...
                        <h1 className="uppercase font-extrabold text-2xl">Phase 1: The Birth of $CPT</h1>
                    </div>

                    <div className=" mx-4 w-[90%] px-3 py-5 text-white bg-black rounded-md mb-6">
                        A new icon enters the meme world. With a quirky story and simple yet impactful tech, $CPT begins its journey to capture hearts and block out the noise.
                    </div>
                    ...
                    <div className=" mx-4 w-[90%] px-3 py-5 text-white bg-black rounded-md mb-6">
                        Spread the word with airdrops and meme competitions. Fun, inclusive events will ignite a $CPT frenzy that everyone can be a part of.
                    </div>
