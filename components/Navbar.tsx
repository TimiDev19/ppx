...
import Logo from '@/assets/earplug.jpg'
        ...
        <div className=' w-[100vw] h-[80px] z-50 fixed'>
            <div className=' w-full h-[80px] bg-orange-400 border-b border-b-green-700 flex items-center justify-between px-[10px]'>
                    ...
                    >
                        ...
                        >
                            ...
                            <ul style={{ listStyle: "none", padding: 0 }}>
                                ...
                                <Link onClick={toggleSidebar} href={'/#about'} className=" mb-4 w-fit rounded-full text-green-700 flex items-center justify-center  hover:text-white duration-500">Roadmap 🗺️</Link>
                ...
                <div className=' hidden lg:flex items-center justify-center'>
                    ...
                    <Link onClick={toggleSidebar} href={'/#about'} className=" w-fit rounded-full text-green-700 flex items-center justify-center  hover:text-white duration-500 mx-4">Roadmap</Link>
                    <div className=" w-full flex items-center justify-between">
